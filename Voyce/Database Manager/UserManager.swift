...
class databaseManager
{
    ...
    // User Manager Construcor
    init()
    {
        // Default user that gets over written when user logs in
        sharedUser = User.init(userID: "0", name: "null", username: "null")
    ...
    public func updateVibes(post:Post)
    {
        print("I AM HERE");
        post.likeCount+=1;
        print(post.postID);
